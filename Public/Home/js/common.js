...
AJAX = {
	...
	alert: function(){
		...
		$.getJSON('/ajax/profit/alert',function(d){
                if(!d.status){
                    if(!$.cookie('alertmana')){
                    $('body').append('<div class="mana-adv mana-adv-up" style="padding:15px;"><p style="font-family:\'hiragino sans gb\';height:40px;line-height: 30px;">邀请用户赚佣金 <img onclick="hidemana(this);$.cookie(\'alertmana\',1,{expires:7});"  style="float:right;cursor:pointer;" src="/images/jubi/x.png" alt=""/> </p> <p style="font-size:14px;color:#777;">推荐给他人即可获得被推荐人半年内交易手续费的30%作为佣金</p> <a class="common-button" style="padding:8px 20px;border-radius:30px;display: inline-block;margin-left:65px;margin-top:15px;" href="/ajax/profit/activity">马上邀请</a> </div>');}
                }else{
    ...
    alertbtc:function(flag){
        ...
        warinhtml += '<div class="dialog-step-1">为了给用户提供更优质的服务， <em style="color:#e55600;font-style:normal;">自7月1日起</em>，比特币（BTC）交易业务将全部转至比特币交易网，该平台免收BTC交易手续费并拥有更活跃的市场，我们将不再提供比特币买卖、转入服务，若给您带来不便敬请谅解。您可以点击下面按钮将BTC一键转存至比特币交易网。<p  style=" margin: 10px 0; ">若您有挂单冻结的比特币资产，请先撤销挂单后再进行转出操作。 <a style="  color: #e55600;text-decoration: underline;" href="/finance/trades.html">立即去撤单</a></p><p>请您于 <em style="color:#e55600;font-style:normal;">7月15日24：00</em>之前完成BTC的转出操作，衷心感谢您的理解与支持。</p>';
        ...
        warinthree += '<div style="text-align:center;padding:35px;font-size:16px;"><div style="font-size:20px;color:#690;"><i style="vertical-align: middle;" class="fa fa-2x fa-check"></i> 创建成功</div>你在BtcTrade的账号为 <span style="color:#e55600;"> '+USER[1]+'</span><div>登录密码，交易密码相同</div></span>   ';
...
function inputFB(){
	$('input').focus(function(){
		var t = $(this);
		if(t.attr('type')=='text'||t.attr('type')=='password')t.css({'box-shadow':'0px 0px 3px #1583fb','border':'1px solid #1583fb','color':'#333','width':'94%'});
...
$(function(){
    ...
    $('.phone').html('<span class="iphone" style=""></span><a href="" target="_blank" class="qqkefu"></a>');
	AJAX.user();
	//输入框效果
	inputFB();
});
