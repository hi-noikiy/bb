...
class UserController extends HomeController
{
	protected function _initialize(){
		parent::_initialize();
		$allow_action=array("index","login","nameauth","upauth","password","mibao","upmibao","uppassword","paypassword","uppaypassword","ga","mobile","upmobile","email","upemail","bank","upbank","delbank","qianbao","upqianbao","delqianbao","log","delcache","dodelcache","rmdirr","feedback","subfeedback","feedbacklist","addreply","feedbackdetail","upauth2");
	...
	public function __construct() {
		parent::__construct();
		$display_action=array("index","login","nameauth","password","mibao","paypassword","ga","mobile","email","bank","qianbao","log","delcache","feedback","feedbacklist","feedbackdetail");
