...
class ToolsController extends AdminController
{
	protected function _initialize(){
		parent::_initialize();
		$allow_action=array("index","delcahe","getDirSize","queue","qianbao","delcache","invoke","rmdirr","recoverzc","chkzdzc");
	...
	public function delcache()
	{
		...
		$dirs = array('./Runtime/','../taiyuemei/Runtime/');
	...
	public function qianbao($id = NULL)
	{
		...
		$update_str = '&nbsp;&nbsp;&nbsp;<a href="' . U('Config/coinEdit', array('id' => $qb_list[$id]['id'])) . '" color="green" target="_black">立即前往修改<a>';
	...
	public function recoverzc(){
		file_put_contents("./Database/lastzc.txt",time());
		echo "恢复完毕，请点击浏览器后退按钮";
		exit;
	}
	public function chkzdzc(){
